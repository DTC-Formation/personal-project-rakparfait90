    ...
    return BottomNavigationBar(
      ...
      items: [
        BottomNavigationBarItem(
          icon: Image.asset('assets/images/icons/fiangonana.png', height: 48),
          label: "Fandraisana",
        ),
        BottomNavigationBarItem(
          icon: Image.asset('assets/images/icons/baiboly.png', height: 48),
          label: "Baiboly",
        ),
        BottomNavigationBarItem(
          icon:
              Image.asset('assets/images/icons/sorona-masina.png', height: 48),
          label: "Sorona Masina",
        ),
        BottomNavigationBarItem(
          icon: Image.asset('assets/images/icons/fihirana.png', height: 48),
          label: "Fihirana",
        ),
        BottomNavigationBarItem(
          icon: Image.asset('assets/images/icons/rozery.png', height: 48),
          label: "Raozery",
        )
      ],
      onTap: (int index) {
